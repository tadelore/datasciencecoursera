...
-Mean of all time and frequency domain variables
-Standard deviation (std) of all time and frequency domain variables
-Activity labels of the time and frequency domain (mean and std) variables 
